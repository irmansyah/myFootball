...
data class SearchMatchResponse(@SerializedName("event")
                               @Expose
                               var events: List<Match>? = null)

data class MatchCombineResponse(val events: List<MatchCombine>)
...
@Parcelize
data class MatchCombine(@SerializedName("idEvent")
                     @Expose
                     var idEvent: String? = null,
                     @SerializedName("idSoccerXML")
                     @Expose
